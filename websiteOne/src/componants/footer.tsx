...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-white absolute pt-16 pb-8 w-full left-0 right-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Transforming retail email personalization with AI-powered solutions.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-start">
                ...
                <span>123 Marketing St, San Francisco, CA 94103</span>
              </li>
        ...
        <div className="border-t border-gray-800 pt-8 pb-4">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-gray-400">Stay updated with the latest in email personalization</p>
            </div>
            <div className="flex flex-col sm:flex-row">
              <input 
                type="email" 
                placeholder="Your email address" 
                className="px-4 py-2 bg-gray-800 text-white rounded-md mb-2 sm:mb-0 sm:mr-2 focus:outline-none focus:ring-2 focus:ring-yellow-500" 
              />
              <button className="bg-yellow-500 text-black px-4 py-2 rounded-md font-medium hover:bg-yellow-400">
                Subscribe
              </button>
            </div>
          </div>
